...
import { ARCADE_APPS } from '../data/content.js?v=20260925i';
import { $, esc, onSeen, REDUCED } from './reveal.js?v=20260925i';
...
function shot(a, cls) {
  return `<div class="${cls}"><img src="${esc(a.shot)}?v=20260925i" alt="${esc(a.title)}" loading="lazy" decoding="async"></div>`;
}
