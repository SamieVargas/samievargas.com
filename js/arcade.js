...
import { ARCADE_APPS } from '../data/content.js?v=20260925g';
import { $, esc, onSeen, REDUCED } from './reveal.js?v=20260925g';
...
function shot(a, cls) {
  return `<div class="${cls}"><img src="${esc(a.shot)}?v=20260925g" alt="${esc(a.title)}" loading="lazy" decoding="async"></div>`;
}
