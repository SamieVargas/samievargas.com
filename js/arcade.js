...
import { ARCADE_APPS } from '../data/content.js?v=20260925a';
import { $, esc, onSeen } from './reveal.js?v=20260925a';
...
function shot(a, cls) {
  return `<div class="${cls}"><img src="${esc(a.shot)}?v=20260925a" alt="${esc(a.title)}" loading="lazy" decoding="async"></div>`;
}
