...
Every certificate and accreditation I hold, with its verify link and every course link underneath it. The work page (`CERT_LIST` in `data/content.js`) and the résumé each carry only the ones most relevant to applied AI and data, so when a new one lands it goes here first and then into either of those if it earns the space.

`site` and `résumé` say where each one currently appears.

## Verified

| Certificate | Issuer · date | Verify | site | résumé |
| --- | --- | --- | --- | --- |
| Anthropic AI Fluency, six courses | Anthropic Academy · Jun 2026 | per course, below | yes | yes |
...
**Anthropic AI Fluency** (Anthropic Academy, Jun 2026)
- [Claude 101](https://verify.skilljar.com/c/9u7jnb7vvof6)
- [Claude Code 101](https://verify.skilljar.com/c/m33jy7xt39an)
- [Introduction to Agent Skills](https://verify.skilljar.com/c/mcpdh7rajijd)
- [Introduction to Claude Cowork](https://verify.skilljar.com/c/akk8bvgh8u8i)
- [AI Capabilities and Limitations](https://verify.skilljar.com/c/5on46yhihy7j)
- [AI Fluency Framework & Foundations](https://verify.skilljar.com/c/ju2k6b9v4ruu)

**Databricks accreditations** (Databricks Academy, Jun 2026)
- [AI Agent Fundamentals](https://credentials.databricks.com/77b2e833-0cf3-4f03-bdb7-5ac7ce9e8024#acc.6YmWJv4O)
- [Generative AI Fundamentals](https://credentials.databricks.com/8d3a5c2b-f47b-43d1-8ce7-86f71f844a2d#acc.maCtXnr3)
...
- [Foundations of Data Science](https://coursera.org/verify/SK0W15V6MEMO)
- [The Power of Statistics](https://coursera.org/verify/SDAR7K2NRNFE)
- [Go Beyond the Numbers: Translate Data into Insights](https://coursera.org/verify/PNO89HH5H95O)
- [Regression Analysis: Simplify Complex Data Relationships](https://coursera.org/verify/SFZWGJ4ZBBI1)
- [The Nuts and Bolts of Machine Learning](https://coursera.org/verify/QXMZF32FDK3M)
...
- [Foundations: Data, Data, Everywhere](https://coursera.org/verify/KXJMWB3146QC)
- [Ask Questions to Make Data-Driven Decisions](https://coursera.org/verify/RB2IYHIXG76M)
- [Prepare Data for Exploration](https://coursera.org/verify/V1L7KY8SNTUO)
- [Process Data from Dirty to Clean](https://coursera.org/verify/OXFEQA45LOMI)
- [Analyze Data to Answer Questions](https://coursera.org/verify/2W8H4CA63SSO)
- [Share Data Through the Art of Visualization](https://coursera.org/verify/G7SHHUWTY4PM)
- [Introduction to Data Analysis Using Python](https://coursera.org/verify/WC7J35JYMF68)
- [Google Data Analytics Capstone](https://coursera.org/verify/3TZFHERTU294)
